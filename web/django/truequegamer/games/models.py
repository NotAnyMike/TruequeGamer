...
class Game(models.Model):
    name: models.CharField(max_lenght=300, null=False, blank=False, unique=True)
    cover: models.URLField(max_lenght=300, null=False, blank=False, unique=True) 
    psPrice: models.URLField(null=False, blank=False, default=null)
    xboxPrice: models.IntegerField(null=True, blank=False, default=null)
